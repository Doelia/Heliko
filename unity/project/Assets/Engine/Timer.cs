...
public abstract class Timer : HelikoObject {
    ...
    //methode à implémenter, elle décrira le comportement lors d'un beat
    protected abstract void beat();
    //methode à implémenter, elle décrira le comportement à la fin de la musique
